...
CFLAGS=-lm -I. -Ifem -Imesh -Wall -ggdb -O0

OBJECTFILES=integrate.o basis.o matrix.o mesh2d.o mtxsolver.o vector.o finite-element.o isoparam.o finite-element1d.o mesh1d.o
